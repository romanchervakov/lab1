public class Testing {
             public static void main(String[] args) {
                                     ...
                                     System.out.println("\nПРОВЕКА ФУНКЦИЙ pop\n");
                                     System.out.println("Запустим каждую из них 100 раз при условии, что в списке меньшее колличество элементов.\n" );
                                     for (int i = 0; i < 99; i++)
                                          list.pop_first();
                                     for (int i = 0; i < 99; i++)
                                          list.pop_last();
                                     ...
                                     list.print();
                                     System.out.println("-----------------");
                                     System.out.println("\nСписок просто очистелся и обращений к чужой памяти не было.\n" );
             }
}
